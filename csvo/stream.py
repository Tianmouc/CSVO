...
def image_stream(queue, imagedir, calib, stride, skip=0):
    ...
    for t, imfile in enumerate(image_list):
        ...
        imfile = str(imfile)
        pathr = imfile.replace("data/","SDR_frames_low_rate/").replace(".png", ".npy")
        pathl = imfile.replace("data/","SDL_frames_low_rate/").replace(".png", ".npy")
        ...
        queue.put((t, image,sdr, sdl, intrinsics))

    queue.put((-1, image,sdr, sdl, intrinsics))
