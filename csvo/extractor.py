...
class BasicEncoder(nn.Module):
    def __init__(self, input_dim=3, output_dim=128, norm_fn='batch', dropout=0.0, multidim=False):
        ...
        self.conv1 = nn.Conv2d(input_dim, DIM, kernel_size=7, stride=2, padding=3)
    ...
    def forward(self, x):
        ...
        x = x.view(b*n, c1, h1, w1).contiguous()
        ...
        _, c2, h2, w2 = x.shape
        return x.view(b, n, c2, h2, w2).contiguous()


class BasicEncoder4(nn.Module):
    def __init__(self, input_dim=3, output_dim=128, norm_fn='batch', dropout=0.2, multidim=False):
